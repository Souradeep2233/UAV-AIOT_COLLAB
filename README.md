...
Our research team has created this brilliant repository, over their research on UAVs and their application in agricultural science, Load transport, weather prediction, and pollution index  from various sensors and edge computations to cloud architecture for visualization and further analysis with machine learning. The system uses an ESP32 microcontroller to read sensor data and establish a Wi-Fi connection for data transmission. Cloud computing and Machine learning are used for further study, analysis, and prediction of weather components and pollution index. Together we have made a complete system basic but compatible with UAV surveillance and exploration  in weather science and forecasting.
## Glimpses
